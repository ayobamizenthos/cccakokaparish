...
const galleryImages: GalleryImage[] = [
  { src: churchExterior, alt: "Glade Cathedral Exterior - Main Building", category: "Exterior" },
  { src: churchInterior, alt: "Glade Cathedral Interior - Worship Hall", category: "Interior" },
  { src: churchExterior, alt: "Cathedral Entrance - Welcome Area", category: "Exterior" },
  { src: churchInterior, alt: "Sanctuary - Sacred Space", category: "Interior" },
  { src: churchExterior, alt: "Cathedral Architecture - Divine Design", category: "Exterior" },
  { src: churchInterior, alt: "Altar Area - Place of Worship", category: "Interior" },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-gradient-gold">Cathedral</span>
          </motion.h2>
          ...
          >
            Explore the beauty of Glade Cathedral through our lens
          </motion.p>
        </motion.div>
          ...
          >
            ...
            <div className="absolute top-0 left-0 right-0 z-20 p-6 flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                {/* Zoom Button */}
                <motion.button
                  className="w-12 h-12 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-white/80 hover:bg-white/20 hover:text-white transition-all duration-300"
                ...
                {/* Close Button */}
                <motion.button
                  className="w-12 h-12 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-white/80 hover:bg-red-500/80 hover:border-red-500 hover:text-white transition-all duration-300"
                  onClick={closeLightbox}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
            ...
            >
              ...
              {/* Image Border Glow */}
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-[hsl(43,90%,52%,0.3)] via-transparent to-[hsl(43,90%,52%,0.3)] opacity-50 blur-sm -z-10" />
            </motion.div>
            
            {/* Navigation Arrows */}
            <motion.button
              className="absolute left-6 top-1/2 -translate-y-1/2 z-20 w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white/80 hover:bg-[hsl(43,90%,52%)] hover:border-[hsl(43,90%,52%)] hover:text-white transition-all duration-300"
            ...
            <motion.button
              className="absolute right-6 top-1/2 -translate-y-1/2 z-20 w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white/80 hover:bg-[hsl(43,90%,52%)] hover:border-[hsl(43,90%,52%)] hover:text-white transition-all duration-300"
